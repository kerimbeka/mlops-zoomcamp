...
def calculate_metrics_postgresql(curr, i):
	...
	trip_distance_mean = result['metrics'][2]['result']['current_characteristics']['mean']
	...
	curr.execute(
		"insert into dummy_metrics(timestamp, prediction_drift, fare_amount_quantile, trip_distance_mean, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s, %s, %s)",
		(begin + datetime.timedelta(i), prediction_drift, fare_amount_quantile, trip_distance_mean, num_drifted_columns, share_missing_values)
	)
